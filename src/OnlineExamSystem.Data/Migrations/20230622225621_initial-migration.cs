        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TakenExamId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentExams_TakenExams_TakenExamId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TakenExamQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TakenExamQuestions_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TakenExamQuestions_TakenExams_TakenExamId",
                        column: x => x.TakenExamId,
                        principalTable: "TakenExams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentExams_TakenExamId",
                table: "StudentExams",
                column: "TakenExamId");

            migrationBuilder.CreateIndex(
                name: "IX_TakenExamQuestions_QuestionId",
                table: "TakenExamQuestions",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_TakenExamQuestions_TakenExamId",
                table: "TakenExamQuestions",
                column: "TakenExamId");
